    ...
    <div className="flex justify-center gap-10">
      <div className="flex flex-col items-center gap-3 -ml-72">
        ...
        <div className="flex flex-col gap-1 items-center">
          ...
          <p className="text-[#B5B9BD] mb-4 text-lg">Bulldog</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          ...
          <p className="text-[#B5B9BD] mb-4 text-lg">Guardian</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[70px] h-[70px] rounded-full">
            <img
          ...
          <p className="text-[#B5B9BD] mb-4 text-lg">Vandal</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[70px] h-[70px] rounded-full">
            <img
          ...
          <p className="text-[#B5B9BD] text-lg mb-4">Phantom</p>
        </div>
      </div>
