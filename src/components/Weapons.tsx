    ...
    <div className="flex justify-center gap-10">
      <div className="flex flex-col items-center gap-3 -ml-72">
        ...
        <div className="flex flex-col gap-1 items-center">
          ...
          <p className="text-[#B5B9BD] mb-4 text-lg">Classic</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[70px] h-[70px] rounded-full">
            <img
          ...
          <p className="text-[#B5B9BD] mb-4 text-lg">Shorty</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[70px] h-[70px] rounded-full">
            <img
          ...
          <p className="text-[#B5B9BD] mb-4 text-lg">Frenzy</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          <div className="bg-[#1A1C20] w-[70px] h-[70px] rounded-full">
            <img
          ...
          <p className="text-[#B5B9BD] text-lg mb-4">Ghost</p>
        </div>
        <div className="flex flex-col gap-1 items-center">
          ...
          <p className="text-white font-semibold text-lg">Sheriff</p>
        </div>
      </div>
      <div className="max-w-[1444px] w-full px-4">
        ...
        <div className="flex flex-col gap-2.5 p-7  bg-[#1A1C1F] h-[200px] md:h-[175px] rounded-t-2xl">
          ...
          <div className="flex items-start gap-6 mt-4">
            ...
            <Link to="/snipers">
              <p className="text-xl text-[#7D8185]">Snipers</p>
            </Link>
            <Link to="/heavy">
