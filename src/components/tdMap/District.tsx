    ...
    <div className="flex justify-between ">
      ...
      <div className="flex flex-col w-[1000px]">
        <div className="flex items-center gap-2 text-xl text-gray-400 font-normal tracking-tighter mb-5">
          ...
          <span>Game Guide / Valorant / Maps / Team Deathmatch /</span>
          <span className="text-white font-normal">District</span>
        </div>

        <div className="flex flex-col gap-8 mt-16">
          <div className="flex items-center gap-3">
            <h1 className="text-5xl text-white font-semibold">District . </h1>
      ...
      <img
        src={map}
        alt="logo"
        className="w-[500px] h-[750px]  mt-16 object-contain "
      />
