    ...
    <div className="flex justify-between ">
      ...
      <div className="flex flex-col w-[1000px]">
        <div className="flex items-center gap-2 text-xl text-gray-400 font-normal tracking-tighter mb-5">
          ...
          <span>Game Guide / Valorant / Maps / Practice /</span>
          <span className="text-white font-normal">The Range</span>
        </div>

        <div className="flex flex-col gap-8 mt-16">
          <div className="flex items-center gap-3">
            <h1 className="text-5xl text-white font-semibold">The Range . </h1>
